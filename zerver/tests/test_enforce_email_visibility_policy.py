...
class EnforceEmailVisibilityPolicyTest(ZulipTestCase):
    ...
    def test_realm_user_settings_defaults_rejects_out_of_policy_min(self) -> None:
        self.login("desdemona")
        realm = self.example_user("desdemona").realm
    ...
    def test_realm_user_settings_defaults_accepts_within_policy_min(self) -> None:
        self.login("desdemona")
        realm = self.example_user("desdemona").realm
        realm.email_address_visibility_min = UserProfile.EMAIL_ADDRESS_VISIBILITY_ADMINS
        realm.save(update_fields=["email_address_visibility_min"])
    ...
    def test_json_change_settings_rejects_out_of_policy_min(self) -> None:
        self.login("hamlet")
        hamlet = self.example_user("hamlet")
        realm = hamlet.realm
        realm.email_address_visibility_min = UserProfile.EMAIL_ADDRESS_VISIBILITY_ADMINS
    ...
    def test_json_change_settings_accepts_within_policy_min(self) -> None:
        self.login("hamlet")
        hamlet = self.example_user("hamlet")
        realm = hamlet.realm
        realm.email_address_visibility_min = UserProfile.EMAIL_ADDRESS_VISIBILITY_ADMINS
...
class RegistrationFormEmailVisibilityFilterTest(ZulipTestCase):
    ...
    def test_registration_form_filters_choices_to_policy_min(self) -> None:
        realm = self.example_user("hamlet").realm
        realm.email_address_visibility_min = UserProfile.EMAIL_ADDRESS_VISIBILITY_ADMINS
        realm.save(update_fields=["email_address_visibility_min"])
        ...
        self.assertNotIn(UserProfile.EMAIL_ADDRESS_VISIBILITY_NOBODY, choice_values)
        self.assertIn(UserProfile.EMAIL_ADDRESS_VISIBILITY_ADMINS, choice_values)
