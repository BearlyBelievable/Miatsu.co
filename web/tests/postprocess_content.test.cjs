...
run_test("collapsed media when thumbnails are hidden", ({override}) => {
    ...
    assert.equal(
        ...
        '<span class="message-media-collapsed-image" data-collapsed-image-html="<div class=&quot;message_inline_image message_inline_video&quot;><a href=&quot;http://zulip.zulipdev.com/user_uploads/w/ha/tever/inline-video-embed.mp4&quot; target=&quot;_blank&quot; rel=&quot;noopener noreferrer&quot;><video src=&quot;http://zulip.zulipdev.com/user_uploads/w/ha/tever/inline-video-embed.mp4&quot;></video></a></div>"><a href="http://zulip.zulipdev.com/user_uploads/w/ha/tever/inline-video-embed.mp4" target="_blank" rel="noopener noreferrer" class="message-media-collapsed-image-link">http://zulip.zulipdev.com/user_uploads/w/ha/tever/inline-video-embed.mp4</a><a role="button" tabindex="0" class="message-media-expand-button icon-button icon-button-square icon-button-neutral" aria-label="translated: Show preview"><i class="zulip-icon zulip-icon-expand" aria-hidden="true"></i></a></span><span class="message-media-collapsed-image" data-collapsed-image-html="<div class=&quot;youtube-video message_inline_image&quot;><a class=&quot;&quot; href=&quot;https://www.youtube.com/watch?v=tyKJueEk0XM&quot; target=&quot;_blank&quot; rel=&quot;noopener noreferrer&quot;><img src=&quot;https://i.ytimg.com/vi/tyKJueEk0XM/default.jpg&quot;></a></div>"><a href="https://www.youtube.com/watch?v=tyKJueEk0XM" target="_blank" rel="noopener noreferrer" class="message-media-collapsed-image-link">https://www.youtube.com/watch?v=tyKJueEk0XM</a><a role="button" tabindex="0" class="message-media-expand-button icon-button icon-button-square icon-button-neutral" aria-label="translated: Show preview"><i class="zulip-icon zulip-icon-expand" aria-hidden="true"></i></a></span><span class="message-media-collapsed-image" data-collapsed-image-html="<div class=&quot;message_embed&quot;><a class=&quot;message_embed_image&quot; href=&quot;https://example.com/about&quot; style=&quot;background-image: url(&amp;quot;https://example.com/preview.jpeg&amp;quot;)&quot;></a><div class=&quot;data-container&quot;><div class=&quot;message_embed_title&quot;><a href=&quot;https://example.com/about&quot;>About us</a></div><div class=&quot;message_embed_description&quot;>All about us.</div></div></div>"><a href="https://example.com/about" target="_blank" rel="noopener noreferrer" class="message-media-collapsed-image-link" title="https://example.com/about">About us</a><a role="button" tabindex="0" class="message-media-expand-button icon-button icon-button-square icon-button-neutral" aria-label="translated: Show preview"><i class="zulip-icon zulip-icon-expand" aria-hidden="true"></i></a></span>',
    );
    assert.equal(
        postprocess_content(
        ...
        '<span class="message-media-collapsed-image" data-collapsed-image-html="<img alt=&quot;dinky-inline-image&quot; class=&quot;inline-image&quot; data-original-content-type=&quot;image/png&quot; data-original-dimensions=&quot;128x128&quot; data-original-src=&quot;/user_uploads/path/to/dinky-inline-image.png&quot; src=&quot;/user_uploads/thumbnail/path/to/dinky-inline-image.png/840x560.webp&quot;>"><a href="/user_uploads/path/to/dinky-inline-image.png" target="_blank" rel="noopener noreferrer" class="message-media-collapsed-image-link">dinky-inline-image</a><a role="button" tabindex="0" class="message-media-expand-button icon-button icon-button-square icon-button-neutral" aria-label="translated: Show preview"><i class="zulip-icon zulip-icon-expand" aria-hidden="true"></i></a></span>',
    );
    assert.equal(
        postprocess_content(
        ...
        '<span class="message-media-collapsed-image" data-collapsed-image-html="<img class=&quot;inline-image&quot; data-original-src=&quot;/user_uploads/path/to/my%20pic.png&quot; src=&quot;/user_uploads/thumbnail/path/to/my%20pic.png/840x560.webp&quot;>"><a href="/user_uploads/path/to/my%20pic.png" target="_blank" rel="noopener noreferrer" class="message-media-collapsed-image-link">my pic.png</a><a role="button" tabindex="0" class="message-media-expand-button icon-button icon-button-square icon-button-neutral" aria-label="translated: Show preview"><i class="zulip-icon zulip-icon-expand" aria-hidden="true"></i></a></span>',
    );
    assert.equal(
        postprocess_content(
        ...
        '<span class="message-media-collapsed-image" data-collapsed-image-html="<img class=&quot;inline-image&quot; data-original-src=&quot;/user_uploads/path/to/bad%E0%A4.png&quot; src=&quot;/user_uploads/thumbnail/path/to/bad%E0%A4.png/840x560.webp&quot;>"><a href="/user_uploads/path/to/bad%E0%A4.png" target="_blank" rel="noopener noreferrer" class="message-media-collapsed-image-link">bad%E0%A4.png</a><a role="button" tabindex="0" class="message-media-expand-button icon-button icon-button-square icon-button-neutral" aria-label="translated: Show preview"><i class="zulip-icon zulip-icon-expand" aria-hidden="true"></i></a></span>',
    );
});
